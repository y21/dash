...
pub struct Statics {
    ...
    pub array_sort: Handle<dyn Object>,
    ...
    pub arraybuffer_byte_length: Handle<dyn Object>,
...
fn function(gc: &mut Gc, name: interner::Symbol, cb: NativeFunction) -> Handle<dyn Object> {
...
impl Statics {
    pub fn new(gc: &mut Gc) -> Self {
        ...
        Self {
            ...
            function_to_string: function(gc, sym::TO_STRING, js_std::function::to_string),
            ...
            object_to_string: function(gc, sym::TO_STRING, js_std::object::to_string),
            object_get_own_property_descriptor: function(
                gc,
                sym::GET_OWN_PROPERTY_DESCRIPTOR,
                js_std::object::get_own_property_descriptor,
            ),
            object_get_own_property_descriptors: function(
                gc,
                sym::GET_OWN_PROPERTY_DESCRIPTORS,
                js_std::object::get_own_property_descriptors,
            ),
            object_has_own_property: function(gc, sym::HAS_OWN_PROPERTY, js_std::object::has_own_property),
            object_define_property: function(gc, sym::DEFINE_PROPERTY, js_std::object::define_property),
            ...
            number_tostring: function(gc, sym::TO_STRING, js_std::number::to_string),
            boolean_ctor: function(gc, sym::BOOLEAN, js_std::boolean::constructor),
            boolean_tostring: function(gc, sym::TO_STRING, js_std::boolean::to_string),
            boolean_prototype: builtin_object(gc, BoxedBoolean::with_obj(false, NamedObject::null())),
            string_ctor: function(gc, sym::BOOLEAN, js_std::string::constructor),
            string_prototype: builtin_object(gc, BoxedString::with_obj(sym::EMPTY.into(), NamedObject::null())),
            is_nan: function(gc, sym::IS_NA_N, js_std::global::is_nan),
            is_finite: function(gc, sym::IS_FINITE, js_std::global::is_finite),
            parse_float: function(gc, sym::PARSE_FLOAT, js_std::global::parse_float),
            parse_int: function(gc, sym::PARSE_INT, js_std::global::parse_int),
            ...
            number_is_finite: function(gc, sym::IS_FINITE, js_std::number::is_finite),
            number_is_nan: function(gc, sym::IS_NA_N, js_std::number::is_nan),
            number_is_safe_integer: function(gc, sym::IS_SAFE_INTEGER, js_std::number::is_safe_integer),
            number_to_fixed: function(gc, sym::TO_FIXED, js_std::number::to_fixed),
            boolean_valueof: function(gc, sym::VALUE_OF, js_std::boolean::value_of),
            string_tostring: function(gc, sym::TO_STRING, js_std::string::to_string),
            string_char_at: function(gc, sym::CHAR_AT, js_std::string::char_at),
            string_char_code_at: function(gc, sym::CHAR_CODE_AT, js_std::string::char_code_at),
            string_concat: function(gc, sym::CONCAT, js_std::string::concat),
            string_ends_with: function(gc, sym::ENDS_WITH, js_std::string::ends_with),
            string_starts_with: function(gc, sym::STARTS_WITH, js_std::string::starts_with),
            string_includes: function(gc, sym::INCLUDES, js_std::string::includes),
            string_index_of: function(gc, sym::INDEX_OF, js_std::string::index_of),
            string_last_index_of: function(gc, sym::LAST_INDEX_OF, js_std::string::last_index_of),
            string_pad_end: function(gc, sym::PAD_END, js_std::string::pad_end),
            string_pad_start: function(gc, sym::PAD_START, js_std::string::pad_start),
            string_repeat: function(gc, sym::REPEAT, js_std::string::repeat),
            string_replace: function(gc, sym::REPLACE, js_std::string::replace),
            string_replace_all: function(gc, sym::REPLACE_ALL, js_std::string::replace_all),
            string_split: function(gc, sym::SPLIT, js_std::string::split),
            string_to_uppercase: function(gc, sym::TO_UPPER_CASE, js_std::string::to_uppercase),
            string_to_lowercase: function(gc, sym::TO_LOWER_CASE, js_std::string::to_lowercase),
            ...
            string_trim_start: function(gc, sym::TRIM_START, js_std::string::trim_start),
            string_trim_end: function(gc, sym::TRIM_END, js_std::string::trim_end),
            string_from_char_code: function(gc, sym::FROM_CHAR_CODE, js_std::string::from_char_code),
            ...
            array_tostring: function(gc, sym::TO_STRING, js_std::array::to_string),
            ...
            symbol_ctor: function(gc, sym::SYMBOL, js_std::symbol::constructor),
            symbol_prototype: builtin_object(
                gc,
                BoxedSymbol::with_obj(Symbol::new(sym::EMPTY.into()), NamedObject::null()),
            ),
            symbol_async_iterator: Symbol::new(sym::ASYNC_ITERATOR.into()),
            symbol_has_instance: Symbol::new(sym::HAS_INSTANCE.into()),
            symbol_is_concat_spreadable: Symbol::new(sym::IS_CONCAT_SPREADABLE.into()),
            symbol_iterator: Symbol::new(sym::ITERATOR.into()),
            symbol_match: Symbol::new(sym::MATCH.into()),
            symbol_match_all: Symbol::new(sym::MATCH_ALL.into()),
            ...
            symbol_to_primitive: Symbol::new(sym::TO_PRIMITIVE.into()),
            symbol_to_string_tag: Symbol::new(sym::TO_STRING_TAG.into()),
            ...
            array_find_index: function(gc, sym::FIND_INDEX, js_std::array::find_index),
            array_flat: function(gc, sym::FLAT, js_std::array::flat),
            array_for_each: function(gc, sym::FOR_EACH, js_std::array::for_each),
            array_includes: function(gc, sym::INCLUDES, js_std::array::includes),
            array_index_of: function(gc, sym::INDEX_OF, js_std::array::index_of),
            array_map: function(gc, sym::LO_MAP, js_std::array::map),
            ...
            array_last_index_of: function(gc, sym::LAST_INDEX_OF, js_std::array::last_index_of),
            array_from: function(gc, sym::FROM, js_std::array::from),
            array_is_array: function(gc, sym::IS_ARRAY, js_std::array::is_array),
            ...
            error_to_string: function(gc, sym::TO_STRING, js_std::error::to_string),
            eval_error_ctor: function(gc, sym::EVAL_ERROR, js_std::error::eval_error_constructor),
            eval_error_prototype: builtin_object(gc, EvalError::empty()),
            range_error_ctor: function(gc, sym::RANGE_ERROR, js_std::error::range_error_constructor),
            range_error_prototype: builtin_object(gc, RangeError::empty()),
            reference_error_ctor: function(gc, sym::REFERENCE_ERROR, js_std::error::reference_error_constructor),
            reference_error_prototype: builtin_object(gc, ReferenceError::empty()),
            syntax_error_ctor: function(gc, sym::SYNTAX_ERROR, js_std::error::syntax_error_constructor),
            syntax_error_prototype: builtin_object(gc, SyntaxError::empty()),
            type_error_ctor: function(gc, sym::TYPE_ERROR, js_std::error::type_error_constructor),
            type_error_prototype: builtin_object(gc, TypeError::empty()),
            uri_error_ctor: function(gc, sym::URI_ERROR, js_std::error::uri_error_constructor),
            uri_error_prototype: builtin_object(gc, URIError::empty()),
            aggregate_error_ctor: function(gc, sym::AGGREGATE_ERROR, js_std::error::aggregate_error_constructor),
            aggregate_error_prototype: builtin_object(gc, AggregateError::empty()),
            arraybuffer_ctor: function(gc, sym::ARRAY_BUFFER, js_std::arraybuffer::constructor),
            arraybuffer_prototype: builtin_object(gc, ArrayBuffer::empty()),
            arraybuffer_byte_length: function(gc, sym::BYTE_LENGTH, js_std::arraybuffer::byte_length),
            ...
            map_set: function(gc, sym::LO_SET, js_std::map::set),
            ...
            regexp_ctor: function(gc, sym::REG_EXP, js_std::regex::constructor),
