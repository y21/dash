...
impl Statics {
    pub fn new(gc: &mut Gc) -> Self {
        ...
        Self {
            ...
            object_define_property: function(gc, "defineProperty", js_std::object::define_property),
            object_assign: function(gc, "assign", js_std::object::assign),
            object_entries: function(gc, "entries", js_std::object::entries),
            ...
            array_sort: function(gc, "sort", js_std::array::sort),
            ...
            arraybuffer_byte_length: function(gc, "byteLength", js_std::arraybuffer::byte_length),
